...
if (estado == "perguntando") {
    ...
    draw_text(centro_x, centro_y - 140, "Tempo Verbal: " + tempo_verbal);
    ...
    if (caractere >= string_length(pergunta)) {
        ...
        draw_text((btn_des_x1 + btn_des_x2) / 2, (btn_des_y1 + btn_des_y2) / 2, "Desistir");
