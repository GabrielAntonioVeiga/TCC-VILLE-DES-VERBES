    ...
    if (clicou_confirmar) {
        ...
        if (opcao_selecionada == resposta_correta) {
            ...
            if (instance_exists(instancia_pai)) {
                instancia_pai.pergunta_salva = -1;
            }
            
     
        var _txt_res = opcoes[resposta_correta];
        var _anotacao = "Quiz: " + string(nome_quiz) + "\n" +
                        "Tempo: " + string(tempo_verbal) + " | Pronome: " + string(pronome) + "\n" +
