...
if (clicou_confirmar) {
        ...
        if (opcao_selecionada == resposta_correta) {
            ...
            // APAGA A PERGUNTA DA MEMÓRIA GLOBAL (Assim a maçã reseta)
            variable_struct_remove(global.pergunta_atual_id, id_memoria);
            
            // SALVA NO BLOCO DE NOTAS
            var _txt_res = opcoes[resposta_correta];
